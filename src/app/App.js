...
function App() {
  ...
  var model, ctx, canvas, videoWidth, videoHeight;
  ...
  async function main() {
    ...
    ctx.drawImage(document.querySelector("video"), 0, 0, videoWidth, videoHeight, 0, 0, canvas.width, canvas.height);
  ...
  return (
    <div className="App" style={{ height: height, width: width }}>
      <video id="cam" style={{ transform: 'scaleX(-1)', position:'absolute' }}></video>
